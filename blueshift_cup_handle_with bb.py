...
def initialize(context):
    ...
    """
    # universe selection
    context.securities = [symbol('TATAPOWER'),symbol('NTPC'),symbol('POWERGRID'),symbol('GAIL'),symbol('IOC'),symbol('RELIANCE'),symbol('BPCL'),symbol('ONGC'),symbol('ADANIGREEN'),symbol('ADANITRANS')]
